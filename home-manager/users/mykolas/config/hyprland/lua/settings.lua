...
-- Devices
hl.device({ name = "apple-inc.-magic-trackpad-1",       sensitivity = 0.1,  accel_profile = "adaptive", scroll_factor = 0.35 })
hl.device({ name = "apple-inc.-magic-trackpad",         sensitivity = 0.1,  accel_profile = "adaptive", scroll_factor = 0.35 })
hl.device({ name = "asue1212:00-04f3:3233-touchpad",    sensitivity = 0.25, accel_profile = "adaptive", scroll_factor = 0.35 })
